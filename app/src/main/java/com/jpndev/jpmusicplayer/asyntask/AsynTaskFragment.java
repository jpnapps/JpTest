...
public class AsynTaskFragment  extends Fragment implements View.OnClickListener{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		return inflater.inflate(R.layout.activity_asyntask, null);
	}
	...
	public void onViewCreated(View view, Bundle savedInstanceState) {
		...
		topLlay = (LinearLayout) view.findViewById(R.id.top_llay);
		progressBar = (ProgressBar) view.findViewById(R.id.progressBar);
		progressBar2 = (ProgressBar) view.findViewById(R.id.progressBar2);
		asyntaskTv = (TextView) view.findViewById(R.id.asyntask_tv);
		homeTv = (TextView) view.findViewById(R.id.home_tv);
		progressTv = (TextView) view.findViewById(R.id.progress_tv);
		progress2_tv = (TextView) view.findViewById(R.id.progress2_tv);
		asyntaskTv.setOnClickListener(this);
	}
...
*/
           ...
           /*    String[] urls=new String[]{"http://www.vogella.com/index.html","https://developer.android.com/reference/android/os/AsyncTask.html"};
			...
			case R.id.home_tv:
				...
				Intent intent=new Intent(getActivity(), HomeCActivity.class);
