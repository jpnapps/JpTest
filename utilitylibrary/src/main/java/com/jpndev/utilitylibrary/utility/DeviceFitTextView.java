...
/**
 * Created by ceino on 27/3/15.
 */
public class DeviceFitTextView extends TextView {
    ...
    private boolean  isAuroResize=false;
// java.lang.RuntimeException: Unable to resume activity {com.ceino.fluidguy/com.ceino.snapsupport.activity.WebActivity}: java.lang.IllegalStateException: RelativeLayout
    public DeviceFitTextView(final Context context) {
        this(context, null, 0);
       // TypefaceManager.initTypeface(this, context, attrs, defStyle);
    }

    public DeviceFitTextView(final Context context, final AttributeSet attrs) {
        this(context, attrs, 0);

    }

    public DeviceFitTextView(final Context context, final AttributeSet attrs, final int defStyle) {
        super(context, attrs, defStyle);
        TypefaceManager.initTypeface(this, context, attrs, defStyle);
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.DeviceFitTextView, defStyle, 0);
        DEFAULT_PERCENTAGEHEIGHT = getHeight();
        DEFAULT_PERCENTAGEWIDTH = getWidth();
        mPercentageWidth = a.getInt(R.styleable.DeviceFitTextView_percentage_width, DEFAULT_PERCENTAGEWIDTH);
        mPercentageHeight = a.getInt(R.styleable.DeviceFitTextView_percentage_height, DEFAULT_PERCENTAGEHEIGHT);
        isAuroResize = a.getBoolean(R.styleable.DeviceFitTextView_isAuroResize, false);
        a.recycle();
